;;; workgroups2-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "workgroups2" '("buffer-list" "wg-" "workgroups-mode"))
...
(register-definition-prefixes "workgroups2-sdk" '("wg-"))
...
(register-definition-prefixes "workgroups2-support" '("wg-"))
